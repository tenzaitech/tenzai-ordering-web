...
export default function LiffBootstrapPage() {
  ...
  useEffect(() => {
    const initializeLiff = async () => {
      ...
      if (!liffId) {
        setStatus('error')
        setErrorMessage('LIFF ID not configured')
        return
      }
  ...
  const getInstructions = () => {
    switch (userOS) {
      case 'ios':
        return 'Tap "Open in LINE" below. If prompted, choose "Open".'
      case 'android':
        return 'Tap "Open in LINE" below. If prompted, allow opening in LINE.'
      default:
        return 'Please open this link on your phone in the LINE app.'
    }
  }
    ...
    return (
      <div className="min-h-screen bg-bg flex items-center justify-center px-5">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-text mb-3">Please open this page in LINE</h1>
    ...
    return (
      <div className="min-h-screen bg-bg flex items-center justify-center px-5">
        <div className="text-center max-w-sm">
          ...
          <h1 className="text-xl font-semibold text-text mb-3">Connection Error</h1>
    ...
    <div className="min-h-screen bg-bg flex items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-text font-medium">
          {status === 'initializing' ? 'Connecting LINE…' : 'Logging in…'}
        </p>
      </div>
    </div>
  )
